...
<!DOCTYPE  html>
<html>
<head><title>-Other-Network-Databundle-VtuTopCenter</title>
	<meta  charset="utf-8">
 ...
 if(isset($_GET['functionError'])){ 
    ...
    switch($_GET['error']){ 
      case "emptyFields":
            ...
            break;
      case "emptyNumber":
            $errorMsg="You did not enter a mobile number.";
            break;
      case "dataFailed":
         ...
         <aside id="dasboard">
         	...
         	<div class="main-dashboard"> 
         		<div class="alternate_inner-div">
					...
					<h1 class='reflink'>Other Network DataBundle: </h1>
...
<p><em><b>Check data Baln : </b></em> GLO: #127*0#   &nbsp; AIRTEL: *140#   &nbsp; 9MOBILE :*229*9# </p>
					 
					 	 	<div class='fieldset' >
					 	<img  id="image" src='../web-images/vtuCenter-logo.png' style="width:70px; height:70px;display:block; margin:7px;"/>
					 	 		<form action="../enclosed/buyOthersData.inc" method="post" id="wallet-form" data-validate="">
					 	 	<div class='row'>
								<label for='Network'>Select  Network: </label> 
								 <select id="network"  name='network' required >
                                		<option value="">-- Select --</option>
                                		<option value="19">GLO</option>
                                		<option value="20">AIRTEL</option>
                                		<option value="21">9MOBILE</option>
                                        
                                      </select>
							</div><br/>
							<div class='row'>
								<label for='Data Type'>Select  Data Bundle: </label> 
								 <select id="dataBundle"  name='dataBundle' required > 
                                		<option value="">-- Select --</option>
							...
							<input type="submit" name='buyData' value="Buy Data Bundle" onClick='return confirmSubmit()'>
						</form>
					</div>
<script LANGUAGE="JavaScript">
	...
	var agree=confirm("You are about to buy data bundle worth of  " +amount+ " on "+ mobile+" ,  press -ok- to confirm else press  -cancel- ");
		if (agree)
		 return true ;
		else
		 return false ;
