...
<!DOCTYPE  html>
<html>
<head><title>Api-Electricity-</title>
    <meta  charset="utf-8">
...
?>
            ...
            <div class="main-dashboard"> 
                ...
                <div class="inner-div">
                    <div class="transaction">
                     <h1>Api- Electricity Transaction </h1>
    ...
    <tr><th> SN</th> <th>Product</th><th>Old Balance</th> <th>Amount Deducted</th> <th>New Balance</th>  <th>Token</th> 
          <th>Date</th><th>User's Name</th><th>Status</th>
            </tr>
        </thead>
            <tbody>
                <?php
                include "../condb.inc/connection.php";
                 $total_pages_sql = "SELECT * FROM apielectrichistory ";
                $result = mysqli_query($con,$total_pages_sql);
                $total_rows=mysqli_num_rows($result);
               
                $total_pages = ceil($total_rows/ $limit);

$sql="SELECT * FROM apielectrichistory ORDER BY  electric_id DESC LIMIT $record_index, $limit";
                $query=mysqli_query($con,$sql);
                if(!empty($query)){
                    $sn=$record_index;
                   while($rows=mysqli_fetch_array($query)){
                        $electric_id=$rows['electric_id']; 
            ...
            <td><?php echo $date; ?></td><td><?php echo $user_fname; ?></td>
            <td>
                 <?php 
if ($status=='no'){
     $status="PENDING";
