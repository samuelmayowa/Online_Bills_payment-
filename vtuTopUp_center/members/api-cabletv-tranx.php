            ...
            <div class="main-dashboard"> 
                ...
                <div class="inner-div">
                    <div class="transaction">
                     <h1>Api- Cable Tv Transaction </h1>
    ...
    <tr><th> SN</th> <th>Bouquet</th><th>Decoder No</th><th>Old Balance</th> <th>Amount Deducted</th> <th>New Balance</th> 
      <th>User's Name</th><th>Status</th> <th>Date</th>
            ...
            <tbody>
                <?php
                include "../condb.inc/connection.php";
                 $total_pages_sql = "SELECT * FROM apicabletvhistory  WHERE User_mobile='$user_num'";
                $result = mysqli_query($con,$total_pages_sql);
                $total_rows=mysqli_num_rows($result);
               
                $total_pages = ceil($total_rows/ $limit);

$sql="SELECT * FROM apicabletvhistory  WHERE User_mobile='$user_num' ORDER BY  cable_id  DESC LIMIT $record_index, $limit";
                $query=mysqli_query($con,$sql);
                if(!empty($query)){
                    $sn=$record_index;
    ...
    <td>&#8358;<?php echo $new_baln; ?></td><td><?php echo $user_fname; ?></td>
    <td>
        <?php 
if ($status=='no'){
     $status="PENDING";
