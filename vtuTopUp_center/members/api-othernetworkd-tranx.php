...
<!DOCTYPE  html>
<html>
<head><title>Api-OthernetworkData-</title>
    <meta  charset="utf-8">
...
?>
            ...
            <div class="main-dashboard"> 
                ...
                <div class="inner-div">
                    <div class="transaction">
                     <h1>Api- Othernetwork Data Transaction </h1>
    ...
    <th>User's Name</th><th>Status</th> <th>Date</th>
            ...
            <tbody>
                <?php
                include "../condb.inc/connection.php";
     $total_pages_sql = "SELECT * FROM apidatabundlehistory  WHERE User_mobile='$user_num' && Network!='Mtn' && BundleSize='single'";
                $result = mysqli_query($con,$total_pages_sql);
                $total_rows=mysqli_num_rows($result);
               
                $total_pages = ceil($total_rows/ $limit);

$sql="SELECT * FROM apidatabundlehistory   WHERE User_mobile='$user_num' && Network!='Mtn' && BundleSize='single'
