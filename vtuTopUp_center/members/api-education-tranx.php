...
<!DOCTYPE  html>
<html>
<head><title>Api-Eductaion-</title>
    <meta  charset="utf-8">
...
?>
            ...
            <div class="main-dashboard"> 
                ...
                <div class="inner-div">
                    <div class="transaction">
                     <h1>Api- Educational Transaction </h1>
    ...
    <tr><th> SN</th> <th>Pin</th><th>Serial</th><th>ExamBody</th><th>Old Balance</th> <th>Amount Deducted</th> <th>New Balance</th> 
       <th>User's Name</th><th>Date</th>
            </tr>
        </thead>
            <tbody>
                <?php
                include "../condb.inc/connection.php";
                 $total_pages_sql = "SELECT * FROM apieducationhistory WHERE User_mobile='$user_num'";
                $result = mysqli_query($con,$total_pages_sql);
                $total_rows=mysqli_num_rows($result);
               
                $total_pages = ceil($total_rows/ $limit);

$sql="SELECT * FROM apieducationhistory WHERE User_mobile='$user_num' ORDER BY  Edu_id DESC LIMIT $record_index, $limit";
                $query=mysqli_query($con,$sql);
                if(!empty($query)){
                    $sn=$record_index;
            ...
            <td><?php echo  $user_fname; ?></td><td><?php echo $date; ?></td>
            </tr>
