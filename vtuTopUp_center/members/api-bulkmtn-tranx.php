...
<!DOCTYPE  html>
<html>
<head><title>Api-Bulk-mtnData-</title>
    <meta  charset="utf-8">
            ...
            <div class="main-dashboard"> 
                ...
                <div class="inner-div">
                    <div class="transaction">
                     <h1>Api-BulkMtn Data Transaction </h1>


    <div  class='paginate' >                 
     <table border="1px" id="table">
       <thead>
    <tr><th> SN</th> <th>Product</th><th>Mobile Nos</th><th>Old Balance</th> <th>Amount Deducted</th> <th>New Balance</th> 
         <th>User's Name</th> <th>Status</th> <th>Date</th>
            </tr>
        </thead>
            <tbody>
                <?php
                include "../condb.inc/connection.php";
     $total_pages_sql = "SELECT * FROM apidatabundlehistory WHERE User_mobile='$user_num' && Network='Mtn' && BundleSize='bulk'";
                $result = mysqli_query($con,$total_pages_sql);
                $total_rows=mysqli_num_rows($result);
               
                $total_pages = ceil($total_rows/ $limit);

$sql="SELECT * FROM apidatabundlehistory   WHERE User_mobile='$user_num' && Network='Mtn' && BundleSize='bulk'
 ORDER BY  trans_id DESC LIMIT $record_index, $limit";
                $query=mysqli_query($con,$sql);
                if(!empty($query)){
                    $sn=$record_index;
          ...
          <td><?php echo  $user_fname; ?></td><td><?php echo $status; ?></td><td><?php echo $date; ?></td>
            </tr>
