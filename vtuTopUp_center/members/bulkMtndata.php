...
<!DOCTYPE  html>
<html>
<head><title>- Bulk MTN Databundle-VtuTopCenter</title>
	<meta  charset="utf-8">
         ...
         <aside id="dasboard">
         	...
         	<div class="main-dashboard"> 
         		<div class="alternate_inner-div">
					...
					<h1 class='reflink'>Buy Bulk Mtn Data Bundle: </h1>
					 ...
					 <div id="registration-form"> <button id='wallet_funding'>Buy Data</button>
					  ...
					  <p><em><b>Check data Baln : </b></em>MTN: *461*4# &nbsp;</p>
					 	 	...
					 	 	<img  id="image" src='../web-images/mtn-logo.jpg'  style="width:70px; height:70px;display:block; margin:7px;"/>
					 	 		<form action="../enclosed/bulkmtnData.inc" method="post" id="wallet-form" data-validate="">  
							<div class='row'>
							...
							<div class='row'>
								<label for='Amount to pay'>Amount To Pay Per Number:</label> 
							<input type="text"  readonly name='amountToPay' id="amountToPay"  value="" /> 
							</div>
							<div class='row'>
							<label for='Amount to pay'>Mobile Numbers separated with commas(,):</label> 
							<textarea name="numbers" id="numbers">
								
							</textarea>
							</div>
							<p id="hint">Please enter maximum of 5 numbers separated in commas.</p>
...
<div class='wallet_table' >
	<table border="1px" id="table">
		<thead>
	<tr><th> SN</th> <th>Product</th><th>Numbers</th><th>Old Balance</th> <th>Amount Deducted</th> <th>New Balance</th> 
		 <th>Status</th> <th>Date</th>
			...
			<tbody>
				<?php
			 	include "../condb.inc/connection.php";
$sql="SELECT * FROM databundlehistory WHERE User_id='$u_id'  && Network='Mtn' && BundleSize='bulk' 
