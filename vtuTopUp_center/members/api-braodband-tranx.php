...
<!DOCTYPE  html>
<html>
<head><title>Api-BroadBandData-</title>
    <meta  charset="utf-8">
            ...
            <div class="main-dashboard"> 
                ...
                <div class="inner-div">
                    <div class="transaction">
                     <h1>Api- BroadBand Data Transaction </h1>
   ...
   <tr><th> SN</th> <th>Bundle Name</th><th>Account No</th><th>Old Balance</th> <th>Amount Deducted</th> <th>New Balance</th> 
      <th>Status</th> <th>Date</th>
            ...
            <tbody>
                <?php
                include "../condb.inc/connection.php";
$total_pages_sql = "SELECT * FROM apibroadbandhistory  WHERE  User_mobile='$user_num' && Network='Smile'";
                $result = mysqli_query($con,$total_pages_sql);
                $total_rows=mysqli_num_rows($result);
               
                $total_pages = ceil($total_rows/ $limit);

$sql="SELECT * FROM apibroadbandhistory WHERE  User_mobile='$user_num' && Network='Smile'
 ORDER BY  broad_id  DESC LIMIT $record_index, $limit";
                $query=mysqli_query($con,$sql);
                if(!empty($query)){
                    $sn=$record_index;
