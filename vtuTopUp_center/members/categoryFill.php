...
<!DOCTYPE  html>
<html>
<head><title>-Add Category-VtuTopCenter</title>
	<meta  charset="utf-8">
...
//lets insert in  data into category table
	$sql="INSERT INTO categories (cat_code,category)
	VALUES('$cat_code',	'$category')";  
	$query=mysqli_query($con,$sql);
	if(mysqli_affected_rows($con)==1){
		echo "<div  class='showSuccess'> Category insertted.</div>";
		//exit();
	}else{
		echo "<div  class='showSuccess'>Category was not inserted.</div>";
	}
         ...
         <aside id="dasboard">
         	...
         	<div class="main-dashboard"> 
         		<div class="alternate_inner-div">
					...
					<h1 class='reflink'>Fill the category  table: </h1>
					
							
					 <div id="registration-form"> 
					 	 <button id='wallet_history'>For category table</button>
					 	 	<div class='fieldset' >
							...
							<div class='row'>
								...
								<input type="text" placeholder="" name='category' id="sub_code" /> 
