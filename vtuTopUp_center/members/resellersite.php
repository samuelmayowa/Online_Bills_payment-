...
<!DOCTYPE  html>
<html>
<head><title>VtuTopCenter-Reseller-website-</title>
	<meta  charset="utf-8">
...
if(isset($_GET['success'])){ 
	 if ($_GET['success']=="walletFunded"){
		...
		$successReport="Wallet Funded successfuly with  ₦".$amount.".  But something went wrong with the URL";
	}
		...
		<section class='container-for-all'>
         <nav>
         	<ul>
		        ...
		        <li>
		         	<a  class='appear'><span><i class="fas fa-fw fa-graduation-cap"></i></span>
		             <span class="collapse">Education</span></a>
		            <ul>
		             	<li><a href="waecPin" >Waec Result Checker</a></li>
		             </ul>
         ...
         <aside id="dasboard">
         	...
         	<div class="main-dashboard"> 
				 ...
				 <div id="registration-form"> <button id='wallet_funding'>Apply for a Site like this:</button> 
					<div class='fieldset' >
						<form action="" method="post" id="wallet-form" data-validate="">
							<div class='row'>
								<label for='amount'>Amount</label> 
								<input type="number" placeholder="Amount to add" name='amount' id="amount" min="1200.00"/> 
								<?php 
									...
									if(firstTime($u_id,$user_num)==true){
										...
										$min_amount_payable=3000;
									}


									echo "<p id='hint'>Minimum wallet funding is ₦". $min_amount_payable. "</p>";
								 ?>
                            ...
                            <div id="for-deposit">
								...
								<p id="hint">Funding via Bank Deposit or Transfer attracts ₦50.00 stamp duty on every deposit.</p>
