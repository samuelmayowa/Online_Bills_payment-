...
<!DOCTYPE  html>
<html>
<head><title>-UpdateProfile-VtuTopCenter</title>
	<meta  charset="utf-8">
...
if(isset($_GET['update'])){ 
  if ($_GET['update']=="success"){ 
	$successReport="Account updated !";
	} else {
		$successReport="Account Updated. but something went wrong with the URL";
	}
    ...
    switch($_GET['error']){ 
      case "emptyFields":
            ...
            break;
      case "failed":
            $errorMsg="Updating the changes failed.";
            break;
         ...
         <aside id="dasboard">
         	...
         	<div class="main-dashboard"> 
         		<div class="alternate_inner-div">
					...
					<h1 class='reflink'>Edit Profile </h1>
					<h1 style='margin-left:3%; color:green;'><em>Wallet balance:</em> ₦<?php $wallet=getWallet($u_id,$user_num);
					 ...
					 <div id="registration-form"> 
					 	 <button>Make Changes and Save It.</button>
					 	 	<div class='fieldset' >
					 	 		<form action="../enclosed/updateProfile.inc" method="post" id="wallet-form" data-validate=""> 
							<div class='row'>
							...
							<div class='row'>
								...
								value="<?php echo $user_num;?> "  readonly /> 
